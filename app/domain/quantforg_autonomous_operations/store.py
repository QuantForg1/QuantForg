"""AOC isolated cache under data/aoc/ — never production tables."""
...
DEFAULT_PATH = ROOT / "data" / "aoc" / "workspace.json"
...
class AocStore:
    ...
    def save_snapshot(self, snap: dict[str, Any]) -> dict[str, Any]:
        with self._lock:
            self._snapshot = {
                "executive_scores": snap.get("executive_scores"),
                "queue": snap.get("work_queue"),
