...
OPERATOR_MANUAL = f"""# QuantForg RC1 - Operator Manual

## Purpose

Prove, with measurable evidence, that QuantForg is consistently profitable,
stable, and safe **before** increasing capital.

## What operators do

1. Run **Production Checklist** (`GET /ite/reliability/rc1`) - expect
   PASS / WARNING / FAIL per subsystem.
2. Run **Smoke Test** (`POST /ite/reliability/rc1/smoke`) - connectivity
   only; **never places real trades**.
...
6. Prefer **{DEFAULT_RC1_CONFIG.min_consecutive_trading_days}-\
{DEFAULT_RC1_CONFIG.recommended_evidence_days} consecutive successful trading \
days** before scale-up.
...
2. Use gateway / MT5 recovery endpoints (`/ite/reliability/recovery/*`) -
   safe-read first.
...
5. **Review** - Update RC validation metrics; do not scale capital after an
   incident until evidence recovers.
"""

MONITORING_GUIDE = f"""# QuantForg RC1 - Monitoring Guide

Watch continuously:

- Go Live Score vs threshold ({DEFAULT_RC1_CONFIG.go_live_score_threshold})
    ...
    return [
        {
            ...
            "path": "docs/production/rc1_guides/OPERATOR_MANUAL.md",
        },
        {
            "id": "deployment",
            "title": "Deployment Guide",
            "path": "docs/production/rc1_guides/DEPLOYMENT_GUIDE.md",
        },
        {
            "id": "recovery",
            "title": "Recovery Guide",
            "path": "docs/production/rc1_guides/RECOVERY_GUIDE.md",
        },
        {
            "id": "incident",
            "title": "Incident Response Guide",
            "path": "docs/production/rc1_guides/INCIDENT_RESPONSE_GUIDE.md",
        },
        {
            "id": "monitoring",
            "title": "Monitoring Guide",
            "path": "docs/production/rc1_guides/MONITORING_GUIDE.md",
        },
        {
            "id": "maintenance",
            "title": "Maintenance Guide",
            "path": "docs/production/rc1_guides/MAINTENANCE_GUIDE.md",
        },
    ]
