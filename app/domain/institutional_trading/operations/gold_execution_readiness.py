...
def production_feature_inventory() -> list[dict[str, Any]]:
    ...
    return [
        ...
        row(
            "Probability Center opportunity selector",
            "threshold 70 / strong 85 / adaptive disabled",
            "primary selector",
            "KEEP",
            authoritative=True,
            can_block=True,
            classification=BarrierClass.SOFT_WAIT.value,
            source="CONFIG",
            path="app/domain/institutional_trading/operations/probability_selector.py",
        ),
        row(
            "Forced Trade",
