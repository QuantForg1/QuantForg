...
BLOCK_CATALOG: list[dict[str, Any]] = [
    {"id": "condition", "category": "Conditions", "label": "Condition", "ports": ["out"], "params": ["op", "left", "right"]},
    {"id": "indicator", "category": "Indicators", "label": "Indicator", "ports": ["out"], "params": ["name", "period"]},
    {"id": "price", "category": "Price", "label": "Price", "ports": ["out"], "params": ["field"]},
    {"id": "risk", "category": "Risk", "label": "Risk", "ports": ["in", "out"], "params": ["max_risk_pct", "lot_size"]},
    {"id": "time", "category": "Time", "label": "Time Filter", "ports": ["out"], "params": ["start_hour", "end_hour"]},
    {"id": "volume", "category": "Volume", "label": "Volume", "ports": ["out"], "params": ["min_volume"]},
    {"id": "news", "category": "News", "label": "News Filter", "ports": ["out"], "params": ["max_impact"]},
    {"id": "session", "category": "Sessions", "label": "Session", "ports": ["out"], "params": ["session"]},
    {"id": "correlation", "category": "Correlation", "label": "Correlation Cap", "ports": ["out"], "params": ["max_corr"]},
    {"id": "ai", "category": "AI", "label": "AI Gate", "ports": ["in", "out"], "params": ["min_confidence"]},
    {"id": "execution", "category": "Execution", "label": "Execution Intent", "ports": ["in"], "params": ["side"]},
    {"id": "exit", "category": "Exit", "label": "Exit Rules", "ports": ["in"], "params": ["sl_distance", "tp_distance"]},
]
...
def compile_strategy_graph(graph: dict[str, Any]) -> dict[str, Any]:
    ...
    if not has_exit:
        warnings.append("No Exit block — default SL/TP distances applied for simulation")
    if not has_exec:
