"""RES isolated report cache under data/res/ — never production tables."""
...
DEFAULT_PATH = ROOT / "data" / "res" / "workspace.json"
...
class ResStore:
    ...
    def save_snapshot(self, snap: dict[str, Any]) -> dict[str, Any]:
        with self._lock:
            self._snapshot = {
                "platform_health": snap.get("platform_health"),
                "reliability_score": snap.get("reliability_score"),
