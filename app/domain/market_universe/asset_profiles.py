...
ASSET_PROFILES: dict[str, dict[str, Any]] = {
    ...
    "STOCKS": _profile(
        "STOCKS",
        trading_sessions=("EQUITY_CASH_HOURS",),
        weekend_behavior="TYPICALLY_CLOSED",
        gap_behavior="CASH_OPEN_GAP_COMMON",
        suitable_timeframes=("M15", "H1", "D1"),
        data_requirements="respect equity cash hours; never assume FX/crypto hours",
        contract_specifics="equity CFD/share; tick/lot from broker",
        correlation_groups=("EQUITIES",),
        market_open_behavior="CASH_HOURS",
    ),
    "COMMODITIES": _profile(
        "COMMODITIES",
        trading_sessions=("COMMODITY_CONTRACT_HOURS",),
        weekend_behavior="TYPICALLY_CLOSED",
        gap_behavior="CONTRACT_OPEN_GAP_COMMON",
        suitable_timeframes=("M15", "H1", "D1"),
        data_requirements="respect commodity contract hours",
        contract_specifics="commodity CFD; tick from broker",
        correlation_groups=("COMMODITIES",),
        market_open_behavior="CONTRACT_HOURS",
    ),
    "OTHER": _profile(
        "OTHER",
        ...
        notes="Synthetic/other when broker exposes. RESEARCH_REQUIRED before shadow.",
