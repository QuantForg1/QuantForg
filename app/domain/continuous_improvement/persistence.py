"""File-backed persistence for Continuous Improvement Program."""
...
def data_path(filename: str) -> Path:
    try:
        ...
        base = Path("data")
    return base / "continuous_improvement" / filename
...
class JsonDocumentStore:
    ...
    def _persist(self) -> None:
        ...
        if len(self._docs) > 4000:
            self._docs = self._docs[-4000:]
        payload = {
            "updated_at": utc_iso(),
