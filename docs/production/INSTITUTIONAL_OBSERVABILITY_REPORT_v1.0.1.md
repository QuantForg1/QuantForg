...
**Generated:** 2026-07-22T22:17:29Z
**Scope:** Monitoring and diagnostics only. Never modifies trading behaviour or prior advisory/governance labs.
...
{
  "overall": "degraded",
  "components_healthy": 11,
  "components_total": 12,
  "alert_count": 0,
  "measured_latencies": 9,
  "error_sample_size": 3,
  "current_uptime_seconds": 0.3,
...
```json
{
  ...
  "components": {
    "api": {
      ...
      "observed_at": "2026-07-22T22:17:29.620917Z"
    },
    "gateway": {
      "status": "healthy",
      "detail": "from ops facts",
      "observed_at": "2026-07-22T22:17:29.620917Z"
    },
    "broker": {
      "status": "healthy",
    ...
    "execution_queue": {
      "status": "degraded",
      "detail": "execution_enabled=false (expected in shadow)",
      "observed_at": "2026-07-22T22:17:29.620917Z"
    },
    "journal_writer": {
      "status": "healthy",
      "detail": "demo journal ok",
      "observed_at": "2026-07-22T22:17:29.620917Z"
    },
    "evidence_lab": {
      "status": "healthy",
...
```json
{
  ...
  "memory_used_mb": null,
  "disk_percent": null,
  "network_bytes_sent": null,
  "network_bytes_recv": null,
  "open_connections": null,
  "queue_depth": 3,
  "database": {
    "status": "unknown",
    "note": "not probed \u2014 never invents"
  },
  "cache": {
    "status": "unknown",
    "note": "not probed \u2014 never invents"
  ...
  "source": "basic",
  "pid": 5244,
  "observed_at": "2026-07-22T22:17:29.864154Z"
}
```
...
```json
{
  "started_at": "2026-07-22T22:17:29.613150Z",
  "current_uptime_seconds": 0.3,
  "uptime_24h_ratio": 0.0,
  "uptime_7d_ratio": 0.0,
  "uptime_30d_ratio": 0.0,
  "restart_history": [
    {
      "timestamp": "2026-07-22T22:17:29.613150Z",
      "event": "process_start",
      "pid": 5244
    }
  ],
  "note": "24h/7d/30d ratios reflect this process lifetime only \u2014 never invents multi-process historical uptime"
}
```
...
```json
{
  ...
  "incident_report": {
    ...
    "generated_at": "2026-07-22T22:17:29.864296Z",
    "observability_only": true
  }
}
```
...
- Investigate system health overall=degraded
