  ...
  return (
    <header className="sticky top-0 z-30 flex h-16 items-center justify-between border-b border-[var(--border)] bg-[var(--bg)]/70 px-4 backdrop-blur-xl sm:px-6">
      ...
      <button
        ...
        className="flex w-full max-w-md items-center gap-2 rounded-md border border-[var(--border)] bg-[var(--surface)] px-3 py-2 text-left text-sm text-[var(--fg-subtle)] transition hover:border-[var(--accent)]/40"
      >
